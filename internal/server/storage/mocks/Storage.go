...
func (_m *Storage) DumpStorageToFile() error {
	ret := _m.Called()
...
func (_m *Storage) GetMetric(ctx context.Context, mType string, mName string) (*models.Metric, error) {
...
func (_m *Storage) GetMetricsList(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *Storage) LoadStorageFromFile() error {
	ret := _m.Called()
...
func (_m *Storage) UpdateMetric(ctx context.Context, metric models.Metric) error {
...
func (_m *Storage) UpdateMetrics(ctx context.Context, metrics models.MetricsList) error {
