...
func (_m *MetricService) GetMetric(ctx context.Context, mType string, mName string) (*models.Metric, error) {
...
func (_m *MetricService) GetMetricsList(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *MetricService) UpdateMetric(ctx context.Context, metric models.Metric) error {
...
func (_m *MetricService) UpdateMetrics(ctx context.Context, metrics models.MetricsList) error {
